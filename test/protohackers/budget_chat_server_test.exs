defmodule Protohackers.BudgetChatServerTest do
  ...
  test "whole flow" do
    {:ok, socket1} = :gen_tcp.connect(~c"localhost", 5004, mode: :binary, active: false, packet: :line)

    {:ok, socket2} = :gen_tcp.connect(~c"localhost", 5004, mode: :binary, active: false, packet: :line)
    ...
    {:ok, socket3} = :gen_tcp.connect(~c"localhost", 5004, mode: :binary, active: false, packet: :line)
